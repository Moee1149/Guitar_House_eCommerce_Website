                ...
                <div id="security" class="tab-content">
                    ...
                    <div class="content-card">
                        ...
                        <form action="/admin/profile" method="POST">
                            ...
                            <button class="save-button" type="submit" name="submit">Update Password</button>
                        </form>
                    </div>
                </div>

                <form action="/admin/profile?tab=store-profile" method="POST" enctype="multipart/form-data">
                    <div id="store-profile" class="tab-content active">
                            ...
                            <div class="card logo-card">
                                <div class="logo-container">
                                    <div class="logo-circle"
                                        style="background-image: url('<?php echo !empty($store['store_logo']) ? $store['store_logo'] : '/public/images/profile/store-profile/default.png'; ?>');
                                                    background-size: cover; background-position: center;">
                                        <input type="file" name="image" id="store-logo-input" accept="image/*" style="display:none;" />
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <div>
                                            ...
                                            <input type="text" class="form-input" name="storename" placeholder="TechVendor Solutions" value="<?= $store['store_name'] ?>" />
                                        </div>
                                        <div>
                                            <label class="form-label">Store Owners</label>
                                    ...
                                    <div class="form-row">
                                        <div>
                                            ...
                                            <div class="input-with-icon">
                                                ...
                                                <input type="email" class="form-input" name="email" placeholder="contact@techvendor.com" value="<?= $store['email'] ?>" />
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div class="input-with-icon">
                                                ...
                                                <input type="tel" class="form-input" name="phone" placeholder="+977 9822479379" value="<?= $store['phone'] ?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="store-additional-information">
                            <div class="card address-card">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" name="address" placeholder="12 Aloknagar,Baneshwor" value="<?= $store['store_address'] ?>" />
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="address-row">
                                        <div>
                                            ...
                                            <input type="text" class="form-input" name="city" placeholder="Kathmandu" value="<?= $store['city'] ?>" />
                                        </div>
                                        <div>
                                            <label class="form-label">State</label>
                                            <input type="text" class="form-input" name="state" placeholder="Bagmati" value="<?= $store['state'] ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="button-div">
                            <button class="upload-btn" type="submit" name="submit" style="padding: 0.5rem 0.8rem; width: 120px"> Save Setting </button>
                        </div>
                    </div>
                </form>
            </main>
