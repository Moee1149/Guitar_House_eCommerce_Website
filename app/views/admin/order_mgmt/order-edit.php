        ...
        <div class="main-content-container">
            ...
            <div style="overflow-y: auto">
                <div class="content-container">
                    ...
                    <form action="/admin/order-mgmt/order-edit?updateorder=<?php echo htmlspecialchars($order_id); ?>" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <select id="payment-type" name="paymentType">
                                                <option value="cash_on_delivery" <?php echo ($payment_type == 'cash_on_delivery') ? 'selected' : ''; ?>> Cash on Delivery </option>
                                                <option value="esewa" <?php echo ($payment_type == 'esewa') ? 'selected' : ''; ?>> E-sewa</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="form-row single">
                                    <div class="form-group">
                                        ...
                                        <textarea id="shipping-address" disabled> <?php echo htmlspecialchars(trim("$shipping_street $shipping_city $shipping_state")); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div style="display: flex; justify-content: flex-end;">
                            <button class="btn btn--secondary" type="submit" name="submit"> Update Order </button>
                        </div>
                    </form>
                </div>
            </div>
