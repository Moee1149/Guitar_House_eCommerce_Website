<div class="main-container-sidebar" id="sidebar">
    ...
    <nav class="nav-menu">
        <div class="nav-item">
            <a href="/customer/dashboard" class="nav-link <?php echo (basename(dirname($_SERVER['PHP_SELF'])) == 'admin') ? 'active' : ''; ?>">
        ...
        <div class="nav-item">
            <a href="/customer/report" class="nav-link <?php echo ($current_page == 'reports.php') ? 'active' : ''; ?>">
                <div class="nav-link-content">
                    <svg class="nav-icon" viewBox="0 0 24 24">
